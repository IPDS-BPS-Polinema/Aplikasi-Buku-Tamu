...
<div class="card">
    ...
    <div class="card-header">
        Data Pendidikan <br><br> <a href="{{route('pendidikan.create')}}" class="btn btn-success">Tambah Data</a>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                                ...
                                <div class="col-4">
                                    <a href="{{ route('pendidikan.show', $item->id)}}" class="btn btn-info">Detail</a>
                                </div>
                                <div class="col-4">
